...
import { MapChartSizeChartProps } from './types';
import {
...
export const MapChartSizeChart: React.FC<MapChartSizeChartProps> = ({
  value,
  onChange = () => {},
}) => {
  ...
  }, [value, chart, onChange]);

  return <div ref={ref} style={{ height: '1300px', width: '100%' }} />;
};

export default MapChartSizeChart;

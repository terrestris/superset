...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!ol|geostyler|remark-gfm|markdown-table|micromark-*.|decode-named-character-reference|character-entities|mdast-util-*.|unist-util-*.|ccount|escape-string-regexp)',
  ],
  globals: {
    __DEV__: true,
    caches: true,

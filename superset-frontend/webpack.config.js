...
const config = {
  ...
  module: {
    rules: [
      ...
      {
        test: /node_modules\/(geostyler|geostyler-style|geostyler-qgis-parser|geostyler-openlayers-parser|geostyler-mapbox-parser|geostyler-sld-parser|geostyler-legend)\/.*\.js$/,
        resolve: {
